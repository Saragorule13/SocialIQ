    ...
    <nav className="fixed flex flex-col w-[30vh] h-screen bg-[#262626] border-r border-neutral-200/20 dark:border-neutral-700/30 z-50">
        ...
        <ul className="space-y-1 px-4 ">
          {[
            ...
            <li key={item.name}>
              <a
                href={item.href}
                className="flex items-center px-4 py-3 text-white hover:bg-gray-100 dark:hover:bg-neutral-700/30 rounded-lg transition-all duration-200"
              >
                <svg
                  className="w-5 h-5"
      ...
      <div className="px-4 py-4 border-t border-neutral-200/20 dark:border-neutral-700/30">
        <div className="flex items-center">
          ...
          <button
            type="button"
            className="ml-auto p-1.5 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-neutral-700/30 transition-all duration-200"
          >
            <svg
              className="w-5 h-5"
              xmlns="http://www.w3.org/2000/svg"
